## Project Memories
- **Autonomous Deployment:** Whenever a change is made to the 'production/' directory, immediately execute './deploy.sh "<summary>"' without waiting for explicit user confirmation to commit/push/release.
