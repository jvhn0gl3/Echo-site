    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-scroll-group">
            <nav class="sidebar-nav">
                ...
                <a href="/dossier.html" class="sidebar-link ${activePage === 'dossier' || activePage === 'resume' ? 'active' : ''}" data-label="DOSSIER"><i class="fas fa-file-pdf"></i> <span>[DOC] dossier</span></a>
            </nav>
        </div>
