    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-scroll-group">
            <nav class="sidebar-nav">
                ...
                <a href="/profile.html" class="sidebar-link ${activePage === 'profile' || activePage === 'about' ? 'active' : ''}" data-label="PROFILE"><i class="fas fa-user"></i> <span>[USR] profile</span></a>
                <a href="/services.html" class="sidebar-link ${activePage === 'services' ? 'active' : ''}" data-label="SERVICES"><i class="fas fa-cube"></i> <span>[SYS] services</span></a>
                <a href="/pricing.html" class="sidebar-link ${activePage === 'pricing' ? 'active' : ''}" data-label="PRICING"><i class="fas fa-dollar-sign"></i> <span>[VAL] pricing</span></a>
                <a href="/projects.html" class="sidebar-link ${activePage === 'projects' ? 'active' : ''}" data-label="PROJECTS"><i class="fas fa-folder"></i> <span>[VAR] projects</span></a>
                ...
                <a href="/connect.html" class="sidebar-link ${activePage === 'connect' ? 'active' : ''}" data-label="CONNECT"><i class="fas fa-plug"></i> <span>[DEV] connect</span></a>
                <a href="/faq.html" class="sidebar-link ${activePage === 'faq' ? 'active' : ''}" data-label="FAQ"><i class="fas fa-question-circle"></i> <span>[FAQ] help</span></a>
