...
(function(){
    ...
    const skillDetails = {
        'frontend': {
            ...
            tech: ['✓ React.js & Next.js', '✓ Vue.js & Nuxt.js', '✓ Angular', '✓ TypeScript', '✓ Tailwind CSS / SCSS', '✓ State Management (Redux, Vuex, NgRx)']
        },
        'backend': {
            title: 'Backend Development',
            icon: 'fa-solid fa-server',
            description: 'Robust and scalable backend systems to power your applications.',
            tech: ['✓ Node.js / Express', '✓ Python / Django / FastAPI', '✓ Go / Gin', '✓ Java / Spring Boot', '✓ RESTful APIs & GraphQL', '✓ Microservices Architecture']
        },
        'database': {
            title: 'Database Engineering',
            icon: 'fa-solid fa-database',
            description: 'Efficient data storage and retrieval with modern database solutions.',
            tech: ['✓ PostgreSQL', '✓ MongoDB', '✓ Redis', '✓ MySQL', '✓ Database Design & Optimization', '✓ Data Migration & Backup']
        },
        'cloud': {
            title: 'Cloud Architecture',
            icon: 'fa-solid fa-cloud',
            description: 'Expert cloud infrastructure and deployment strategies.',
            tech: ['✓ AWS (EC2, S3, Lambda, RDS)', '✓ Azure', '✓ Google Cloud Platform', '✓ Docker & Kubernetes', '✓ Infrastructure as Code (Terraform)', '✓ Serverless Architecture']
        },
        'mobile': {
            title: 'Mobile Development',
            icon: 'fa-solid fa-mobile-alt',
            description: 'Cross-platform mobile applications with native performance.',
            tech: ['✓ React Native', '✓ Flutter', '✓ Swift (iOS)', '✓ Kotlin (Android)', '✓ App Store & Play Store Deployment', '✓ Mobile UI/UX Best Practices']
        },
        'devops': {
            title: 'DevOps & CI/CD',
            icon: 'fa-solid fa-code-branch',
            description: 'Streamlined development workflows and automated deployments.',
            tech: ['✓ CI/CD Pipelines', '✓ Jenkins / GitHub Actions', '✓ Git & Version Control', '✓ Automated Testing', '✓ Monitoring & Logging', '✓ Performance Optimization']
        }
    };
    ...
    const serviceDetails = {
        'logo-design': {
            ...
            features: ['✓ Custom concept development', '✓ Multiple revision rounds', '✓ Vector files + all formats', '✓ Brand guidelines included', '✓ Color palette suggestions']
        },
        'web-dev': {
            title: 'Web Development',
            icon: 'fa-laptop-code',
            description: 'Full-stack web development using modern frameworks and best practices.',
            features: ['✓ Responsive mobile-first design', '✓ Modern frameworks (React, Vue, Angular)', '✓ Backend APIs (Node.js, Python, Go)', '✓ Database integration', '✓ Performance optimization']
        },
        'ui-ux': {
            title: 'UI/UX Design',
            icon: 'fa-palette',
            description: 'Beautiful, intuitive interfaces designed with user experience at the core.',
            features: ['✓ User research & personas', '✓ Wireframing & prototyping', '✓ High-fidelity mockups', '✓ Usability testing', '✓ Design systems & components']
        },
        'consulting': {
            title: 'Tech Consulting',
            icon: 'fa-chart-line',
            description: 'Expert technical advice to help you make the right architectural decisions.',
            features: ['✓ Architecture review', '✓ Technology stack selection', '✓ Scalability planning', '✓ Code quality assessment', '✓ Team mentorship']
        },
        'performance': {
            title: 'Performance Optimization',
            icon: 'fa-rocket',
            description: 'Speed up your applications and improve user experience with performance tuning.',
            features: ['✓ Load time analysis', '✓ Core Web Vitals optimization', '✓ Code splitting & lazy loading', '✓ Caching strategies', '✓ Database query optimization']
        },
        'security': {
            title: 'Security Audits',
            icon: 'fa-shield-alt',
            description: 'Comprehensive security assessments to identify and fix vulnerabilities.',
            features: ['✓ Vulnerability scanning', '✓ Penetration testing', '✓ Code security review', '✓ Dependency analysis', '✓ Security best practices implementation']
        },
        'maintenance': {
            title: 'Maintenance & Support',
            icon: 'fa-headset',
            description: 'Ongoing support to keep your applications running smoothly.',
            features: ['✓ 24/7 monitoring', '✓ Bug fixes & patches', '✓ Regular updates', '✓ Performance monitoring', '✓ Emergency response']
        },
        'cloud': {
            title: 'Cloud Migration',
            icon: 'fa-cloud-upload-alt',
            description: 'Seamless migration to cloud platforms with minimal downtime.',
            features: ['✓ AWS, Azure, GCP expertise', '✓ Migration strategy planning', '✓ Cost optimization', '✓ Infrastructure as Code', '✓ CI/CD pipeline setup']
        }
    };
    ...
    function setActiveOnScroll(){
        let sections = ['about', 'skills', 'services'];
